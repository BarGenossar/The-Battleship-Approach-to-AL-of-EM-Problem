...
In this work, we use [DITTO](https://github.com/megagonlabs/ditto), as a black box producing hidden representations for candidate pairs, as well as predicted label and confidence. 
