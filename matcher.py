...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default='WDC/wdc_cameras_title_small')
    parser.add_argument("--input_path", type=str, default='data/wdc/cameras/title/')
    parser.add_argument("--output_path", type=str, default='output/WDC/small/Computers-Cameras/')
